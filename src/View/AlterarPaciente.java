...
public class AlterarPaciente extends javax.swing.JFrame {
    ...
    public AlterarPaciente(int linhaSelecionada) {
        initComponents();
        
        paciente = pacienteBd.listar().get(linhaSelecionada);
        String id = Long.toString(paciente.getId());
        campoId.setText(id);
        campoNome.setText(paciente.getNome());
        String idade = Long.toString(paciente.getIdade());
        campoIdade.setText(idade);
        campoNasc.setText(paciente.getDataNasc());
        ...
        campoNomePai.setText(paciente.getNomePai());
        campoNomeMae.setText(paciente.getNomeMae());
        campoEsco.setText(paciente.getEscolaridade());
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Atualizar Paciente");
    ...
    private void btnAltActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAltActionPerformed
        ...
        int id = new Integer(campoId.getText());
        p.setId(id);
        ...
        if (!campoNome.getText().isEmpty() || !campoIdade.getText().isEmpty() || !campoNomeMae.getText().isEmpty() || !campoNomePai.getText().isEmpty() || !campoEsco.getText().isEmpty()) {
            pacienteBd.alterar(p);
            JOptionPane.showMessageDialog(null, "Paciente atualizado com sucesso.", "Paciente", JOptionPane.INFORMATION_MESSAGE);
